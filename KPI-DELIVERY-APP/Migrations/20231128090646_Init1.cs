        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerProfile_Customers_CustomerEmail",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "15-дюймовий лаптоп", "Лаптоп", 1200m, 10 });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "Description", "Name", "Price", "StockQuantity" },
                values: new object[] { 2, "Android смартфон", "Смартфон", 500m, 20 });

            migrationBuilder.CreateIndex(
                name: "IX_CustomerProfile_CustomerEmail",
